...
FORWARD_LIST='/panfs/roc/scratch/liux1299/outgroups/Adapter_Trimming/murinum_split_fastq/murinum_forward_parts_list.txt'
#   What is our reverse read?
REVERSE_LIST='/panfs/roc/scratch/liux1299/outgroups/Adapter_Trimming/murinum_split_fastq/murinum_reverse_parts_list.txt'
