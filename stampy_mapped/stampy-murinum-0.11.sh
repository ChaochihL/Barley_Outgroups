...
#PBS -l mem=62gb,nodes=2:ppn=24,walltime=96:00:00
#PBS -m abe
...
FORWARD='/home/morrellp/liux1299/scratch/outgroups/Adapter_Trimming/murinum_Forward_ScytheTrimmed.fastq.gz'
#   What is our reverse read?
REVERSE='/home/morrellp/liux1299/scratch/outgroups/Adapter_Trimming/murinum_Reverse_ScytheTrimmed.fastq.gz'
...
stampy -g "${REF_PREFIX}" \
       ...
       -t "${N_THREADS}" \
       -f sam \
       -o "${OUT_DIR}/${SAMPLE_NAME}_0.11.sam" \
       -M "${FORWARD}","${REVERSE}"
