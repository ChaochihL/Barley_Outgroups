...
#SBATCH -o bam_to_fasta-bp.sh.%A_%a.out
#SBATCH -e bam_to_fasta-bp.sh.%A_%a.err
...
BAM_LIST=/panfs/roc/groups/9/morrellp/shared/Datasets/Alignments/barley_outgroups/Indel_Realigner/bp_bam_list.txt
