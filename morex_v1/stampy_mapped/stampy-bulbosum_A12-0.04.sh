...
FORWARD='/home/morrellp/liux1299/scratch/outgroups/Adapter_Trimming/bulbosum_A12_R1_trimmed.fastq.gz'
#   What is our reverse read?
REVERSE='/home/morrellp/liux1299/scratch/outgroups/Adapter_Trimming/bulbosum_A12_R2_trimmed.fastq.gz'
#   Takes our forward read and generates sample name for output file
SAMPLE_NAME="$(basename ${FORWARD} | cut -f 1,2 -d '_')"
