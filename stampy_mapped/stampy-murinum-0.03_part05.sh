...
FORWARD='/panfs/roc/scratch/liux1299/outgroups/Adapter_Trimming/murinum_split_fastq/murinum_Forward_ScytheTrimmed_part05.fastq.gz'
#   What is our reverse read?
REVERSE='/panfs/roc/scratch/liux1299/outgroups/Adapter_Trimming/murinum_split_fastq/murinum_Reverse_ScytheTrimmed_part05.fastq.gz'
