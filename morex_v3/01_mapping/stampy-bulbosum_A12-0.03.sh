...
FORWARD='/scratch.global/liux1299/barley_outgroups/Adapter_Trimming/bulbosum_A12_Forward_ScytheTrimmed.fastq.gz'
#   What is our reverse read?
REVERSE='/scratch.global/liux1299/barley_outgroups/Adapter_Trimming/bulbosum_A12_Reverse_ScytheTrimmed.fastq.gz'
